...
Adapted from https://github.com/crmne/cookiecutter-modern-datascience/blob/master/tests/test_creation.py
"""
import shutil
...
FILES = [".gitignore", ".pre-commit-config.yaml", "LICENSE", "pyproject.toml", "README.md"]
FOLDERS = [
    Path("data"),
    Path("data", "interim"),
    Path("data", "raw"),
    ...
    Path("notebooks"),
    Path("notebooks", "exploratory"),
    Path("notebooks", "reports"),
    Path("src"),
    Path("src", "data"),
    Path("src", "models"),
    Path("src", "utils")
